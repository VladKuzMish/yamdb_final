# Проект YaMDB
![Github actions](https://github.com/VladKuzMish/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)
...
## Развернутый проетк можно посмотреть по ссылке:
http://158.160.65.185:8080/api/v1/
